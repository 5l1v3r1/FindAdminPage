...
print "\t>#  o                  o                   o                                                      #\n";
print "\t>#  OoO                o                   o                                                      #\n";
print "\t>#  o    O  'OoOo. .oOoO        .oOoO' .oOoO  `oOOoOO. O  'OoOo.       .oOo. .oOoO' .oOoO .oOo.   #\n";
print "\t>#  O    o   o   O o   O        O   o  o   O   O  o  o o   o   O       O   o O   o  o   O OooO'   #\n";
print "\t>#  o    O   O   o O   o        o   O  O   o   o  O  O O   O   o       o   O o   O  O   o O       #\n";
print "\t>#  O'   o'  o   O `OoO'o       `OoO'o `OoO'o  O  o  o o'  o   O       oOoO' `OoO'o `OoOo `OoO'   #\n";
print "\t>#                                                                    O                O          #\n";
print "\t>#----------------------------------------------- _______________________________                 #\n";
print "\t># This tool searches for a site control page  #  | {We Are Anonymous Arabs}  :) }                #\n";
print "\t># the best tool for this job :)               #  | {We Are Legion}              }                #\n";
print "\t># {by<---Oseid Aldary--->}        (JOKER11)   #  | {We Are Don't Forgive}       }                #\n";
print "\t>#  FindAdminPageV1.0                          #  | {we Are Don't Forget}        }                #\n";
print "\t>#                                             #  | {expect us}                  }                #\n";
print "\t>#------------------------------------------------------------------------------------------------#\n";
print "\t># For Help Please Visit My Account{https://www.facebook.com/profile.php?id=100017170449859}      #\n";
print "\t>#------------------------------------------------------------------------------------------------#\n";
print "\n";
...
print "-> start finding the page for you :) ...\n\n\n";
